...
export default function Opiniones() {
  ...
  // Reset page if opinions change and current page is out of range
  ...
  // Fix page if out of bounds after opinions load
  useEffect(() => {
    ...
    <section id="opiniones" className="min-h-screen flex flex-col justify-center py-12 sm:py-16 md:py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          {/* Opinions Display with Pagination */}
          <motion.div
                ...
                {mostrarPaginacion && (
                  <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-200">
                    ...
                    <span className="text-sm text-muted-foreground">
                      Mostrando {(paginaEfectiva - 1) * OPINIONES_POR_PAGINA + 1}
                      –{Math.min(paginaEfectiva * OPINIONES_POR_PAGINA, opiniones.length)} de {opiniones.length} opiniones
                    </span>
